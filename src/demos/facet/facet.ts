  ...
  cs: [
    {
      id: 'a',
      name: 'Terminal',
      desc: 'Dark · monospace · developer-native',
      preview: '#0F172A',
    },
    {
      id: 'b',
      name: 'Lumen',
      desc: 'Light · clean · product-engineer',
      preview: '#F8FAFC',
    },
  ],
  architecture: [
    {
      id: 'a',
      name: 'Blueprint',
      desc: 'Technical grid · drafting-room blue',
      preview: '#1E3A5F',
    },
    {
      id: 'b',
      name: 'Atelier',
      desc: 'Warm editorial · gallery presentation',
      preview: '#F5F0E8',
    },
  ],
  medical: [
    {
      id: 'a',
      name: 'Clinical',
      desc: 'Crisp white · trust-forward teal',
      preview: '#F0FDFA',
    },
    {
      id: 'b',
      name: 'Scholar',
      desc: 'Academic navy · serif credentials',
      preview: '#0F1729',
    },
  ],
}
...
export const FACET_FIELD_CONFIG: Record<FacetField, FacetFieldConfig> = {
  ...
  architecture: {
    ...
    fields: [
      ...
      },
      {
        ...
        placeholder: 'AutoCAD, Revit, Rhino…',
      },
      {
        key: 'projects',
  ...
  medical: {
    ...
    defaults: {
      certificates:
        'Board Certified Internal Medicine · 2019\nACLS & BLS — current',
    ...
    fields: [
      {
        key: 'certificates',
        label: 'Certificates & board exams',
      ...
      },
      {
        ...
        placeholder: 'Medical syndicate, GMC, etc.',
      },
    ],
  },
}
...
export function normalizePortfolio(portfolio: FacetPortfolio): FacetPortfolio {
  ...
  const gallery =
    Array.isArray(portfolio.galleryPhotos) &&
    portfolio.galleryPhotos.some((u) => u.trim())
